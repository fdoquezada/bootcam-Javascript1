...
const getInfoCompletaAlumno =  async(id) => {
 
    try {
        let alumno =  await getAlumno(id).nombre;
        let bootcamp = await getBootcamp(id);
...
//<script src="https://pastebin.com/embed_js/8KUd8v70"></script>
//<script src="https://pastebin.com/embed_js/n4FLWFKX"></script>
//<script src="https://pastebin.com/embed_js/teNuNEdq"></script>